        ...
        <div class="admin-form-page">
            ...
            <header class="page-header">
                ...
                <div class="page-actions">
                    ...
                    <button type="button" class="btn btn-primary" id="saveBtn" onclick="saveEvent()">
                ...
                <div class="form-layout">
                    ...
                    <div class="form-main">
                        ...
                        <section class="admin-card">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="title" type="text" placeholder="Enter event title" autocomplete="off">
                        ...
                        <section class="admin-card">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" rows="5"
                                    placeholder="Write a short event description..."></textarea>
                        ...
                        <section class="admin-card">
                            ...
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-secondary" onclick="addScheduleRow()">
                    ...
                    <aside class="form-sidebar">
                        ...
                        <section class="admin-card">
                            ...
                            <div id="featuredDateFields" style="display:none;">
                        ...
                        <section class="admin-card">
                            ...
                            <div class="form-group">
                                ...
                                <input id="map_url" placeholder="https://maps.google.com/...">
                            </div>
                        ...
                        <section class="admin-card">
                            ...
                            <div class="form-group">
                                ...
                                <input id="meta_title" placeholder="SEO title">
                            </div>

                            <div class="form-group" style="margin-top:20px;">
                                <label for="meta_description">Meta Description</label>
                                <textarea id="meta_description" rows="4" placeholder="SEO description"></textarea>
                            </div>
